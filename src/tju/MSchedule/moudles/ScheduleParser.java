...
public class ScheduleParser implements ScheduleParserConstants {
  ...
  final public Orderings Orderings() throws ParseException {
    ...
    jj_consume_token(0);
      {if (true) return orderings;}
    throw new Error("Missing return statement in function");
  }

  final public Ordering Ordering() throws ParseException {
    Event beforeEvent;
    SimpleEvent afterEvent;
    beforeEvent = Event();
    jj_consume_token(ARROW);
    afterEvent = SimpleEvent();
      {if (true) return new Ordering(beforeEvent, afterEvent);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public SimpleEvent SimpleEvent() throws ParseException {
    Token t;
    ...
    default:
      ...
      {if (true) return new SimpleEvent(new Name(eventName), new Name(threadName));}
    throw new Error("Missing return statement in function");
  }

  final public BlockEvent BlockEvent() throws ParseException {
    Token t;
    String blockAfterEventName;
    String blockBeforeEventName = null;
    String threadName = null;
    jj_consume_token(LBRAC);
    t = jj_consume_token(NAME);
                   blockAfterEventName = t.image;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case COLON:
      jj_consume_token(COLON);
      t = jj_consume_token(NAME);
                               blockBeforeEventName = t.image;
      break;
    default:
      jj_la1[3] = jj_gen;
      ;
    ...
    default:
      ...
      {if (true) return new BlockEvent(new Name(blockAfterEventName), new Name(blockBeforeEventName), new Name(threadName));}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x40,0x4080,0x1000,0x2000,0x1000,};
   }
